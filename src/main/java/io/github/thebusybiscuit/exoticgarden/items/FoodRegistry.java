...
public final class FoodRegistry {
    ...
    public static void register(@Nonnull ExoticGarden plugin, @Nonnull ItemGroup misc, @Nonnull ItemGroup drinks, @Nonnull ItemGroup food) {
        ...
        new ItemStack[] {getItem("TEA_LEAF"), new ItemStack(Material.SUGAR), SlimefunItems.HEAVY_CREAM.item().clone(), getItem("COCONUT_MILK"), null, null, null, null, null})
        .register(plugin);
        ...
        new ItemStack[] {new ItemStack(Material.PUMPKIN), new ItemStack(Material.SUGAR), SlimefunItems.WHEAT_FLOUR.item().clone(), null, null, null, null, null, null},
        8)
        .register(plugin);
        ...
        new ItemStack[] {SlimefunItems.WHEAT_FLOUR.item().clone(), new ItemStack(Material.SUGAR), getItem("BLACK_PEPPER"), null, null, null, null, null, null})
        .register(plugin);
        ...
        new ItemStack[] {new ItemStack(Material.COCOA_BEANS), SlimefunItems.HEAVY_CREAM.item().clone(), null, null, null, null, null, null, null},
        3)
        .register(plugin);
        ...
        new ItemStack[] {getItem("YEAST"), SlimefunItems.WHEAT_FLOUR.item().clone(), null, null, null, null, null, null, null},
        4)
        .register(plugin);
        ...
        new ItemStack[] {SlimefunItems.WHEAT_FLOUR.item().clone(), SlimefunItems.BUTTER.item().clone(), null, null, null, null, null, null, null},
        4)
        .register(plugin);
        ...
        new ItemStack[] {new ItemStack(Material.SUGAR), SlimefunItems.WHEAT_FLOUR.item().clone(), SlimefunItems.HEAVY_CREAM.item().clone(), new ItemStack(Material.EGG), null, null, null, null, null},
        16)
        .register(plugin);
        ...
        new ItemStack[] {new ItemStack(Material.SUGAR), getItem("BLACKBERRY"), SlimefunItems.WHEAT_FLOUR.item().clone(), null, null, null, null, null, null},
        12)
        .register(plugin);
        ...
        new ItemStack[] {getItem("LEMON"), getItem("STRAWBERRY"), new ItemStack(Material.SUGAR), new ItemStack(Material.EGG), SlimefunItems.HEAVY_CREAM.item().clone(), null, null, null, null},
        18)
        .register(plugin);
        ...
        new ItemStack[] {SlimefunItems.BUTTER.item().clone(), getItem("CORN"), null, null, null, null, null, null, null},
        9)
        .register(plugin);
        ...
        new ItemStack[] {SlimefunItems.HEAVY_CREAM.item().clone(), getItem("CORN"), new ItemStack(Material.BOWL), null, null, null, null, null, null},
        8)
        .register(plugin);
        ...
        new ItemStack[] {getItem("HAMBURGER"), SlimefunItems.CHEESE.item().clone(), null, null, null, null, null, null, null},
        13)
        .register(plugin);
        ...
        new ItemStack[] {SlimefunItems.CHEESE.item().clone(), getItem("GARLIC"), new ItemStack(Material.BREAD), null, null, null, null, null, null},
        13)
        .register(plugin);
        ...
        new ItemStack[] {new ItemStack(Material.CARROT), SlimefunItems.WHEAT_FLOUR.item().clone(), new ItemStack(Material.SUGAR), new ItemStack(Material.EGG), null, null, null, null, null},
        12)
        .register(plugin);
        ...
        new ItemStack[] {getItem("CHICKEN_BURGER"), SlimefunItems.CHEESE.item().clone(), null, null, null, null, null, null, null},
        13)
        .register(plugin);
        ...
        new ItemStack[] {getItem("CABBAGE"), new ItemStack(Material.CARROT), SlimefunItems.WHEAT_FLOUR.item().clone(), new ItemStack(Material.COOKED_BEEF), getItem("TOMATO"), null, null, null, null},
        16)
        .register(plugin);
        ...
        new ItemStack[] {new ItemStack(Material.COOKED_CHICKEN), new ItemStack(Material.CARROT), SlimefunItems.WHEAT_FLOUR.item().clone(), new ItemStack(Material.POTATO), null, null, null, null, null},
        17)
        .register(plugin);
        ...
        new ItemStack[] {getItem("CHOCOLATE_BAR"), new ItemStack(Material.SUGAR), SlimefunItems.WHEAT_FLOUR.item().clone(), SlimefunItems.BUTTER.item().clone(), new ItemStack(Material.EGG), null, null, null, null},
        17)
        .register(plugin);
        ...
        new ItemStack[] {getItem("CHOCOLATE_BAR"), new ItemStack(Material.SUGAR), SlimefunItems.WHEAT_FLOUR.item().clone(), SlimefunItems.BUTTER.item().clone(), SlimefunItems.HEAVY_CREAM.item().clone(), null, null, null, null},
        12)
        .register(plugin);
        ...
        new ItemStack[] {getItem("BLUEBERRY"), new ItemStack(Material.SUGAR), SlimefunItems.WHEAT_FLOUR.item().clone(), SlimefunItems.BUTTER.item().clone(), SlimefunItems.HEAVY_CREAM.item().clone(), new ItemStack(Material.EGG), null, null, null},
        13)
        .register(plugin);
        ...
        new ItemStack[] {new ItemStack(Material.PUMPKIN), new ItemStack(Material.SUGAR), SlimefunItems.WHEAT_FLOUR.item().clone(), SlimefunItems.BUTTER.item().clone(), SlimefunItems.HEAVY_CREAM.item().clone(), new ItemStack(Material.EGG), null, null, null},
        13)
        .register(plugin);
        ...
        new ItemStack[] {getItem("CHOCOLATE_BAR"), new ItemStack(Material.SUGAR), SlimefunItems.WHEAT_FLOUR.item().clone(), SlimefunItems.BUTTER.item().clone(), SlimefunItems.HEAVY_CREAM.item().clone(), new ItemStack(Material.EGG), null, null, null},
        13)
        .register(plugin);
        ...
        new ItemStack[] {null, getItem("CHOCOLATE_BAR"), null, null, SlimefunItems.HEAVY_CREAM.item().clone(), null, null, getItem("BISCUIT"), null},
        9)
        .register(plugin);
        ...
        new ItemStack[] {getItem("CHOCOLATE_BAR"), SlimefunItems.HEAVY_CREAM.item().clone(), null, null, null, null, null, null, null},
        8)
        .register(plugin);
        ...
        new ItemStack[] {getItem("SWEET_POTATO"), new ItemStack(Material.EGG), SlimefunItems.HEAVY_CREAM.item().clone(), SlimefunItems.WHEAT_FLOUR.item().clone(), null, null, null, null, null},
        13)
        .register(plugin);
        ...
        new ItemStack[] {getItem("CHOCOLATE_BAR"), new ItemStack(Material.SUGAR), SlimefunItems.WHEAT_FLOUR.item().clone(), SlimefunItems.BUTTER.item().clone(), getItem("COCONUT"), null, null, null, null},
        18)
        .register(plugin);
        ...
        new ItemStack[] {getItem("TOMATO"), getItem("CHEESE"), SlimefunItems.WHEAT_FLOUR.item().clone(), getItem("TOMATO"), getItem("CHEESE"), new ItemStack(Material.COOKED_BEEF), null, null, null},
        17)
        .register(plugin);
        ...
        new ItemStack[] {getItem("CHOCOLATE_BAR"), new ItemStack(Material.SUGAR), SlimefunItems.WHEAT_FLOUR.item().clone(), SlimefunItems.BUTTER.item().clone(), getItem("PEAR"), new ItemStack(Material.EGG), null, null, null},
        19)
        .register(plugin);
        ...
        new ItemStack[] {getItem("OAK_APPLE"), new ItemStack(Material.SUGAR), SlimefunItems.WHEAT_FLOUR.item().clone(), SlimefunItems.BUTTER.item().clone(), getItem("PEAR"), new ItemStack(Material.EGG), null, null, null},
        18)
        .register(plugin);
